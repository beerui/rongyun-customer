...
const counter = computed(() =>
  lb.urls.length > 1 ? `${lb.index + 1} / ${lb.urls.length}` : '',
)
</script>
...
<template>
  <Teleport to="body">
    <div
      v-if="lb.isOpen"
      class="fixed inset-0 z-[9999] bg-black/85 flex items-center justify-center select-none"
      @click="lb.close"
    >
      <button
      ...
      <div
        class="max-w-[92vw] max-h-[88vh] flex items-center justify-center"
        @click="stop"
      >
